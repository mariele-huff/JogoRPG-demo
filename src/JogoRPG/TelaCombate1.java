 ...
 * @author mari
 */
public class TelaCombate1 extends javax.swing.JFrame {
    ...
    public TelaCombate1() {
       ...
       /* try {
            Globais.tocarSom("som.wav");
        } catch (UnsupportedAudioFileException ex) {
            Logger.getLogger(TelaCombate1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblNHeroi, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, 110, -1));

        btnAtaque.setBackground(new java.awt.Color(102, 102, 0));
        btnAtaque.setFont(new java.awt.Font("Laksaman", 0, 15)); // NOI18N
        btnAtaque.setForeground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(btnAtaque, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 150, 80, 30));

        btnAvançar.setBackground(new java.awt.Color(102, 102, 0));
        btnAvançar.setFont(new java.awt.Font("Laksaman", 0, 15)); // NOI18N
        btnAvançar.setForeground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(lblLy, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -30, 620, 580));
    ...
    private void btnAtaqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtaqueActionPerformed
       ...
       try{
        int vidaHerroi = pbHeroi.getValue();
        int vidaVilao = pbVilao.getValue();
        
        pbVilao.setValue(vidaVilao - Globais.gerarNumero(objPersonagem.getAtaque()));
        pbHeroi.setValue(vidaHerroi - Globais.gerarNumero(objVilao.getAtaque()));
        ...
        if (pbVilao.getValue() == 0) {
           ...
           System.out.println("Erro btnAtaquePerformed: " +ex.getMessage());
       }
    ...
    private void btnAvançarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvançarActionPerformed
        ...
        if (pbVilao.getValue() == 0) {
            ...
            objArquivo.fecharArquivo();
        TelaNivel2 tela8 = new TelaNivel2();
        tela8.setVisible(true);
        dispose();
        }else if (pbVilao.getValue()!=0){
            Globais.exibirMensagem("Você perdeu!");
            new TelaMapa().setVisible(true);
            dispose();
        }
        
        }catch(Exception ex){
            System.out.println("Erro btnAvançar: " + ex.getMessage());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCombate1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
