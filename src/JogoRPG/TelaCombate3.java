 ...
 * @author mari
 */
public class TelaCombate3 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCombate3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
