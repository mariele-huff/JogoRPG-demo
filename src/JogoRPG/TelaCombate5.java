 ...
 * @author mari
 */
public class TelaCombate5 extends javax.swing.JFrame {
    ...
    private void btnAtaqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtaqueActionPerformed
        ...
        int progressV = pbVilao.getValue();
        pbVilao.setValue(progressV - Globais.gerarNumero(objPersonagem.getAtaque()));

        int progressH = pbHeroi.getValue();
        pbHeroi.setValue(progressH - Globais.gerarNumero(20));
        ...
        if (pbVilao.getValue() == 0) {
            ...
            btnAvançar.setVisible(true);
            Globais.exibirMensagem("Perdeu trouxa kkkk");
            btnAtaque.setVisible(false);
        } else {
            btnAvançar.setVisible(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCombate5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
